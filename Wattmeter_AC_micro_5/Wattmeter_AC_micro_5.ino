...
//----AC1--------
  ...
  float Filter_I1 = (Filter1()*1100.0/1000.0);
  //float Filter_I1 = sensor1.getCurrentAC(60) *1000.0 *1 / 1;
//----AC2--------
  sensor2.setZeroPoint(zero_point2);

  float Filter_I2 = (Filter2()*1100.0/1030.0);
  //float Filter_I2 = sensor2.getCurrentAC(60) *1000.0 *1 / 1;
